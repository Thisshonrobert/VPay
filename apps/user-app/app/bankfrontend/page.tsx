...
export default function BankFrontendPage() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-blue-50 to-gray-50 p-4">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex justify-center gap-4 items-center">
            ...
            <svg className="w-12 h-12" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
              <rect width="100" height="100" fill="#FF6B35" rx="8"/>
              <text x="50" y="50" fontSize="12" fontWeight="bold" fill="white" textAnchor="middle" dy="0.3em">HDFC</text>
            </svg>
          </div>
        </div>
