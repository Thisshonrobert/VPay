/*
  ...
  - The values [Sent,Received] on the enum `P2pStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "P2pStatus_new" AS ENUM ('Success', 'Failure');
